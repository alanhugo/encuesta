 ...
 */
	...
	}elseif(isset($_SERVER['SERVER_NAME']) && in_array($_SERVER['SERVER_NAME'], array('sistrado.altagora')) !== false){
 ...
 */
	...
	Configure::write('Security.cipherSeed', '201257422012230090722012');
